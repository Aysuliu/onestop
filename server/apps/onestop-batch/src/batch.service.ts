...
import { Member } from '../../onestop-api/src/libs/dto/member/member';
import { Property } from '../../onestop-api/src/libs/dto/property/property';
import { Model } from 'mongoose';
import { InjectModel } from '@nestjs/mongoose';
import { PropertyStatus } from '../../onestop-api/src/libs/enums/property.enum';
import { MemberStatus, MemberType } from '../../onestop-api/src/libs/enums/member.enum';
...
export class BatchService {
  ...
  public getHello(): string {
    return 'Welcome to Onestop Batch Server!';
  }
}
